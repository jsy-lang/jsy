...
const {scan_javascript} = require('jsy-transpile/dist/scanner/scan_javascript')
...
describe @ 'Scanners', @=> ::
  describe @ 'Walk Offside', @=> ::
    ...
    it.skip @ 'Can self-verify locations match original source', @=> ::

    it.skip @ 'Can walk a tree of offside indents', @=> ::

    it @ 'matches this offside AST structure', @=> ::
      check_ast_entry @ offside_ast[0], @{}
        type: 'offside_line'
        ...
        content: @[]
         @{} type: 'src'
             loc: @{} start: { line: 1, pos: 9, line_pos: 0 }, end: { line: 1, pos: 42, line_pos: 0 }
             content: 'export function hash_fnv32(sz) ::', is_ws: false


      check_ast_entry @ offside_ast[1], @{}
        type: 'offside_line'
      ...
      check_ast_entry @ offside_ast[2], @{}
        ...
        content: @[]
         @{} type: 'src',
             loc: { start: { line: 3, pos: 165, line_pos: 154 }, end: { line: 3, pos: 184, line_pos: 154 } },
             content: 'let h = 0x811C9DC5 ', is_ws: false

         @{} type: 'comment_eol',
             loc: { start: { line: 3, pos: 165, line_pos: 154 }, end: { line: 3, pos: 214, line_pos: 154 } },
             content: '// fnv-1a 32 bit initial value'

      check_ast_entry @ offside_ast[3], @{}
        type: 'offside_line',
        ...
        content: @[]
         @{} type: 'src',
             loc: { start: { line: 4, pos: 225, line_pos: 214 }, end: { line: 4, pos: 259, line_pos: 214 } },
             content: 'for let i=0; i < sz.length; i++ ::', is_ws: false

      check_ast_entry @ offside_ast[4], @{}
        type: 'offside_line',
        ...
        content: @[]
         @{} type: 'src'
             loc: { start: { line: 5, pos: 272, line_pos: 259 }, end: { line: 5, pos: 293, line_pos: 259 } },
             content: 'h ^= sz.charCodeAt(i)', is_ws: false

      check_ast_entry @ offside_ast[5], @{}
        type: 'offside_line'
        ...
        content: @[]
         @{} type: 'src'
             loc: { start: { line: 6, pos: 306, line_pos: 293 }, end: { line: 6, pos: 364, line_pos: 293 } },
             content: 'h += (h << 24) + (h << 8) + (h << 7) + (h << 4) + (h << 1)', is_ws: false

      check_ast_entry @ offside_ast[6], @{}
        type: 'offside_line'
        ...
        content: @[]
         @{} type: 'src'
             loc: { start: { line: 7, pos: 375, line_pos: 364 }, end: { line: 7, pos: 383, line_pos: 364 } },
             content: 'return h', is_ws: false

      check_ast_entry @ offside_ast[7], @{}
        type: 'offside_blank_line'
        loc: { start: { line: 8, pos: 383, line_pos: 383 }, end: { line: 8, pos: 383, line_pos: 383 } },
        is_blank: true


function check_ast_entry(ast, structure) ::
